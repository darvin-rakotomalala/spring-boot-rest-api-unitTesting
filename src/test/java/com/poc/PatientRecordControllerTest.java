...
import com.poc.controller.PatientRecordController;
...
public class PatientRecordControllerTest {
	...
	public void createRecord_success() throws Exception {
		...
		record.setPatientId(4l);
		record.setName("John Doe");
		record.setAge(47);
		record.setAddress("New York USA");
	...
	public void updatePatientRecord_success() throws Exception {
		PatientRecord updatedRecord = new PatientRecord();
		updatedRecord.setPatientId(1l);
		updatedRecord.setName("Rayven Zambo");
		updatedRecord.setAge(23);
		updatedRecord.setAddress("Cebu Philippines");
